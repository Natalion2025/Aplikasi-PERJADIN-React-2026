...
router.get('/api/pembayaran', isApiAuthenticated, async (req, res) => {
...
router.get('/api/pembayaran/:id', isApiAuthenticated, async (req, res) => {
    try {
...
router.get('/api/pembayaran/check/by-spt/:spt_id', isApiAuthenticated, async (req, res) => {
...
router.put('/api/pembayaran/:id', isApiAuthenticated, async (req, res) => {
    try {
        const { id } = req.params;
        const data = req.body;
...
router.delete('/api/pembayaran/:id', isApiAuthenticated, async (req, res) => {
