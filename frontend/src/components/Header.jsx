      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="p-1 text-slate-200 rounded-xl hover:bg-mauve-100/20 duration-300 cursor-pointer transition-all relative"
            title={
              notifCount > 0
                ? `Ada ${notifCount} SPT yang belum dilaporkan`
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden sm:block">
              <p className="text-md font-semibold text-slate-200 capitalize leading-tight">
