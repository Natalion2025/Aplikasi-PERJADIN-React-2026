    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-900">
      ...
      <div
        className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ease-in-out ${
          sidebarOpen ? 'md:pl-72' : 'md:pl-20' // Disesuaikan dengan lebar sidebar
        }`}
      >
        {/* Header */}
    ...
    <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
      <AuthProvider>
        <Routes>
          ...
          />
          <Route
            path="/cetak/sppd/:spt_id/:pegawai_id"
            element={
              <ProtectedRoute>
                <CetakSPPD />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/cetak/sppd-detail/:sppd_id"
            element={
              <ProtectedRoute>
                <CetakSPPD />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/cetak/pengeluaran-riil/:id"
            element={
              <ProtectedRoute>
                <CetakPengeluaranRiil />
              </ProtectedRoute>
