        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-400">Kelola informasi pangkat, golongan, jabatan, dan bidang pegawai.</p>
                </div>
                <button 
                    onClick={handleAdd}
                        ...
                        <table className="min-w-full divide-y divide-slate-100">
                            <thead className="bg-slate-50/60">
                                <tr>
                                    ...
                                    <th className="px-5 py-4 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Nama Lengkap / NIP</th>
                                    <th className="px-5 py-4 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Pangkat / Golongan</th>
                                    <th className="px-5 py-4 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Jabatan</th>
                                    <th className="px-5 py-4 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Bidang</th>
                                ...
                                {pegawaiList.map((pegawai, index) => (
                                    <tr key={pegawai.id} className="hover:bg-slate-50/20 transition-colors">
                                        ...
                                        <td className="px-5 py-4">
                                            ...
                                            <p className="text-xs text-slate-400 mt-0.5">{pegawai.golongan ? `Gol. ${pegawai.golongan}` : '-'}</p>
                                        </td>
                                        <td className="px-5 py-4 text-slate-700 font-medium">{pegawai.jabatan}</td>
                                        <td className="px-5 py-4">
                                            <span className="inline-flex px-2.5 py-1 rounded-xl text-xs font-bold bg-indigo-50/50 text-indigo-600 border border-indigo-100">
                                                {pegawai.bidang || '-'}
                                            </span>
                                        </td>
                                        <td className="px-5 py-4">
                    ...
                    <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl border border-slate-100 flex flex-col max-h-[90vh]">
                        ...
                        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                ...
                                {/* NIP */}
                                <div>
                                    <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1.5">NIP (Nomor Induk Pegawai) *</label>
                                    <input 
                                        type="text" 
                                        name="nip"
                                        required
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {/* Pangkat */}
                                    <div>
                                        <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1.5">Pangkat</label>
                                        <input 
                                            type="text" 
                                            name="pangkat"
                                            value={form.pangkat}
                                    ...
                                    {/* Golongan */}
                                    <div>
                                        <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1.5">Golongan</label>
                                        <select 
                                            name="golongan"
                                            value={form.golongan}
                                            onChange={handleChange}
                                ...
                                {/* Jabatan */}
                                <div>
                                    <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1.5">Jabatan *</label>
                                    <input 
                                        type="text" 
                                        name="jabatan"
                                        required
                                ...
                                {/* Bidang / Urusan */}
                                <div>
                                    <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1.5">Bidang / Bagian</label>
                                    <input 
                                        type="text" 
                                        name="bidang"
                                        value={form.bidang}
