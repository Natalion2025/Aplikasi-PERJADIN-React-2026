        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
          <div className="relative w-full sm:max-w-xs">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-mauve-500 dark:focus:ring-emerald-600/20 focus:border-none dark:text-slate-100 dark:focus:border-emerald-500"
            />
          </div>
          {isAdminOrSuper && (
            <button
