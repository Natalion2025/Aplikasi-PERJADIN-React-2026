  ...
  return () => (
    <div className="bg-mauve-100 p-8 rounded-3xl border border-slate-100 shadow-sm space-y-4">
      ...
      <p className="text-sm text-slate-500">
        Halaman ini sedang dalam proses pemindahan dari versi HTML legacy ke React.
      </p>
      <div className="flex gap-4">
        <Link
          to="/dashboard"
          className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-sm font-semibold shadow-md shadow-indigo-600/10"
        >
...
export const DaftarPejabat = createSkeleton('Daftar Pejabat');
...
export const CetakSPT = () => (
  <div className="p-8">
    Mempersiapkan Cetak SPT...{' '}
    <button onClick={() => window.print()} className="px-4 py-2 bg-indigo-600 text-white rounded">
      Print
    </button>
  </div>
);
...
export const CetakPembayaran = () => (
  <div className="p-8">
    Mempersiapkan Cetak Pembayaran...{' '}
    <button onClick={() => window.print()} className="px-4 py-2 bg-indigo-600 text-white rounded">
      Print
    </button>
  </div>
...
export const CetakPengeluaranRiil = () => (
  <div className="p-8">
    Mempersiapkan Cetak Pengeluaran Riil...{' '}
    <button onClick={() => window.print()} className="px-4 py-2 bg-indigo-600 text-white rounded">
      Print
    </button>
  </div>
...
export const CetakPembatalan = () => (
  <div className="p-8">
    Mempersiapkan Cetak Pembatalan...{' '}
    <button onClick={() => window.print()} className="px-4 py-2 bg-indigo-600 text-white rounded">
      Print
    </button>
  </div>
